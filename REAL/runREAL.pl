...
$R = "0.5/100/0.1/10/5"; # example: use a small grid size
# $R = "0.1/200/0.1/10/2.5"; # example: use a large grid size
# -G(trx/trh/tdx/tdh)
$G = "3/100/0.02/2";
# -V(vp0/vs0/[s_vp0/s_vs0/ielev])
$V = "6.2/3.3";
# -S(np0/ns0/nps0/npsboth0/std0/dtps/nrt[drt/nxd/rsel/ires])
# $S = "3/2/5/3/1/0/10/0.2/10/10"; # example: use a small grid size
$S = "3/2/5/2/1/0/1.5/0.2/10/10"; # example: use a large grid size

$dir = "/Users/katoh/Desktop/compile_WI/for_REAL/160128.205310";
$station = "/Users/katoh/Desktop/compile_WI/station_WI.dat";
